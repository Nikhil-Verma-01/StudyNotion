...
const timeline = [
    {
        Logo: Logo1,
        heading: "Leadership",
        Description: "Fully committed to the success for company",
    },
    {
        Logo: Logo2,
        heading: "Leadership",
        ...
        <div className='flex flex-row gap-15 items-center'>
            ...
            <div className='relative shadow-blue-200'>
                ...
                left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                    <div className='flex flex-row gap-5 items-center border-r border-caribbeangreen-300 mx-8'>
